<div class="container">
	<h1 class="orange-text">ほら吹き社会人ポータル（仮） Revised</h1>
	<p>
		本サイトをご覧いただき、ありがとうございます。<a href="https://buratsuki.work/" target="_blank" rel="noopener">東京工業大学アグリコラサークル「ぶらつき学生連盟」さんが作成されたOSS</a>を元にしたサイトです。<br>
		身内での対戦記録を主な目的としています。
	</p>
	...
	<div class="row">
		<div class="col s12 m6">
			<h2 class="teal-text">更新履歴</h2>
			<dl>
				<dt class="teal-text">2020/03/29</dt>
				<dd>仮オープン</dd>
			</dl>
		</div>
		<div class="col s12 m6">
